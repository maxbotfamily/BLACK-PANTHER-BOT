...
module.exports = {
    ...
    CHANNEL: 'https://chat.whatsapp.com/LvlMjqqI1563Gaeu2ReTOh',
    SESSION: process.env.BLACKPANTHER_SESSION === undefined ? '' : process.env.BLACKPANTHER_SESSION,
    ...
    MENUTEXT: process.env.MENU_TEXT === undefined ?'*BLACK PANTHER🇱🇰*' : process.env.MENU_TEXT,
    MENU_LOGO: process.env.MENU_LOGO === undefined ?  'https://i.ibb.co/cC36K6L/IMG-20210809-221124.jpg' : process.env.MENU_LOGO,
